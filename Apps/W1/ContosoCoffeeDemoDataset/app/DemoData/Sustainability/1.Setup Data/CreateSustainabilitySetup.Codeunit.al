codeunit 5212 "Create Sustainability Setup"
{
    ...
    begin
        ...
        SustainabilitySetup.Validate("Emission Decimal Places", '3:5');

        SustainabilitySetup.Validate("Reporting UOM Factor", 1000);
        SustainabilitySetup.Validate("Emission Reporting UOM Code", CommonUoM.Ton());

        SustainabilitySetup.Validate("Fuel/El. Decimal Places", '2:5');
        SustainabilitySetup.Validate("Distance Decimal Places", '1:3');
